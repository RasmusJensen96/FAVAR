function [laglength, AIC, SCC, HQC,logL] = VARlag_all_GP(ENDO,maxlag,const,EXOG,lag_ex)
% =======================================================================
...
laglength = [find(AIC==min(AIC)),find(SCC==min(SCC)),find(HQC==min(HQC))  ];
