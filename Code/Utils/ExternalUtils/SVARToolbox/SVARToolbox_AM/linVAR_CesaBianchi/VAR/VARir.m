function [IRF, VAR, response] = VARir(VAR,VARopt)
% =======================================================================
...
%   modified by Giovanni Pellegrino, Oct 2019
...
for mm=1:nvar
    ...
    if impact==0
        if mm == VARopt.NegativeShockIndex
            impulse(mm,1) = -1; % one negative stdev shock
        else
    ...
    elseif impact==1
        ...
        %impulse(mm,1) = impact/invA(mm,mm); % Giovanni
    end
