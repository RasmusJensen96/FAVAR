...
%               1           4          -1];        % VAR3
%
% Modified by Giovanni Pellegrino, Nov. 2019 
...
while jj < ndraws
    kk = kk+1;
    if jj==0 && kk>8000, error('Max number of iterations reached. Try different sign restrictions'), end
...
%     VAR_draw.sigma = sigma_draw;
    ...
    [IRF_draw, VAR_draw response] = VARir(VAR_draw,VARopt);
