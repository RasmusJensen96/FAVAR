function SRfevdplot(FEVD,VARopt,INF,SUP)
% =======================================================================
% Plot the FEVDs computed with SR (sign restriction procedure)
% =======================================================================
% SRfevdplot(FEVD,VARopt,INF,SUP)
% -----------------------------------------------------------------------
% INPUT
...
%===============================================
filename = [VARopt.figname 'FEVD_SR'];
quality = VARopt.quality;
suptitle = VARopt.suptitle;
pick = VARopt.pick;

% Initialize FEVD matrix
nshocks = length(snames); [nsteps, nvars, ~] = size(FEVD);
